  ...
  <div id="auth">
    <div class="container">
      <div class="content">
        ...
        <input v-model="password" :class="[{'is-invalid': error}, 'password']" class="text-center form-control form-control-lg" style="margin-bottom:10px;" placeholder="Password" required>
